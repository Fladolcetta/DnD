...
def test_load_left_right_page(mock_render_template) -> None:
    ...
    calls = [
        call("left_right_split_body.html", left_content="left", right_content="right"),
        call(
            "base.html",
            subtitle="Subtitle",
            content="<html>Mocked HTML</html>",
            other_styles="    <link rel='stylesheet' type='text/css' href='/static/container.css'>\n    <link rel='stylesheet' type='text/css' href='/static/left_and_right.css'>\n    <link rel='stylesheet' type='text/css' href='/static/inputs.css'>\n",
        ),
    ]
...
def test_load_left_only_page(mock_render_template) -> None:
    ...
    calls = [
        call("left_only_body.html", left_content="left"),
        call(
            "base.html",
            subtitle="Subtitle",
            content="<html>Mocked HTML</html>",
...
def test_load_create_character(
    mock_character,
    mock_character_class,
    mock_race,
