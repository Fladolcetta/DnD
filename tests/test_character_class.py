...
def test_character_class_initialization() -> None:
    ...
    assert barbarian.skill_proficiencies == [
        "Animal Handling",
        "Athletics",
        "Intimidation",
        "Nature",
...
def test_get_hit_die(class_name, expected_hit_die) -> None:
...
@pytest.mark.parametrize(
    ("class_name", "expected_primary_stat"),
    [
        ("Barbarian", ["Strength"]),
        ("Bard", ["Charisma"]),
...
def test_get_primary_stat(class_name, expected_primary_stat) -> None:
...
@pytest.mark.parametrize(
    ("class_name", "expected_worst_stat"),
    [
...
def test_get_worst_stat(class_name, expected_worst_stat) -> None:
...
@pytest.mark.parametrize(
    ("class_name", "expected_saving_throws"),
    [
...
def test_get_saving_throw_proficiencies(class_name, expected_saving_throws) -> None:
...
def test_get_skill_proficiencies(class_name, expected_skills) -> None:
