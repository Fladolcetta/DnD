...
def test_print_single_value() -> None:
...
def test_print_dict_with_modifiers() -> None:
...
def test_print_dict_with_data_and_modifiers() -> None:
...
def test_print_basic_stats() -> None:
...
def test_print_class_info() -> None:
...
def test_print_roll_success(mock_dice) -> None:
...
@patch("src.text_printer.Dice")
def test_print_roll_fail(mock_dice) -> None:
    """Test the print_roll method."""
